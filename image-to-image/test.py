...
parser.add_argument('--nepochs', type=int, default=4, help='saved model of which epochs') #origin 200
...
if opt.direction == "a2b":
    ...
    image_dir = "dataset1/{}/test/a/".format(opt.dataset)
else:
    # image_dir = "dataset/{}/test/b/".format(opt.dataset)
    image_dir = "dataset1/{}/test/b/".format(opt.dataset)
